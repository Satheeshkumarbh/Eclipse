...
public class FrameworkActionLibrary 
{
	...
	//-------------------------------------------------------------------
	public FrameworkActionLibrary(String sProperyFile)
	{
...
public void click(String sLocator)
{
	...
	//-----------------------------------------------------------------------------------------
public void setCheckbox(String sLocator, boolean bStatus)
{
	{
	...
	//-----------------------------------------------------------------------------------------
public void setRadiobutton(String sLocator, boolean bStatus)
{
	{
